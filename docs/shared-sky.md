...
更新: 2026-09-16 / v0.8.0 / 状態: 初回の共有ルームとPC・VR編集を実装。Quest実機との組合せは未検証。
...
実装・自動確認の結果は[進捗](progress-overview.md)、起動と配布は[公開手順](deployment.md)を参照。1〜4はコードと模擬環境で確認し、5は公開後にPC＋Quest 3の実機試遊を残す。
